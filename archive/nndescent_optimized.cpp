...
int main(int argc, char** argv) {
    ...
    if (argc != 2) {
        cerr << "Usage: ./nndescent_optimized <h5_file>\n";
        return -1;
    }
    ...
    cout << "==================================================\n";
    cout << "   SISAP 2026: OPTIMIZED NN-DESCENT ENGINE        \n";
    cout << "==================================================\n";
    ...
    cout << "[2] Applying Int8 Quantization...\n";
    ...
    cout << "[4] Starting Dynamic NN-Descent Optimization...\n";
    ...
    for (int iter = 0; iter < max_iterations; ++iter) {
        ...
        for (int i = 0; i < NUM_VECTORS; ++i) {
            ...
            local_pool.reserve(K_BUILD * K_BUILD + K_BUILD);
            ...
            for (int k = 0; k < K_BUILD; ++k) {
                ...
                for (int k2 = 0; k2 < K_BUILD; ++k2) {
                    ...
                    __builtin_prefetch(&int8_data[n2 * DIM], 0, 1);
